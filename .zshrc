...
alias hflabels='gh label create --force "tribe: ${TRIBE}" && gh label create --force "squad: ${SQUAD}" && gh pr edit $(git rev-parse --abbrev-ref HEAD) --add-label "tribe: ${TRIBE}" --add-label "squad: ${SQUAD}"'
